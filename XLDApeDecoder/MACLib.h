...
public:
    ...
    *********************************************************************************************/
    ...
    //        generic parameter... usage is listed in APE_DECOMPRESS_FIELDS
    //////////////////////////////////////////////////////////////////////////////////////////////
    virtual intorptr_t GetInfo(APE_DECOMPRESS_FIELDS Field, intorptr_t nParam1 = 0, int nParam2 = 0) = 0;
};
...
extern "C"
{
    ...
    DLLEXPORT int __stdcall CompressFileW(const char * pInputFilename, const char * pOutputFilename, int nCompressionLevel = COMPRESSION_LEVEL_NORMAL, int * pPercentageDone = NULL, APE_PROGRESS_CALLBACK ProgressCallback = 0, int * pKillFlag = NULL);
    DLLEXPORT int __stdcall DecompressFileW(const char * pInputFilename, const char * pOutputFilename, int * pPercentageDone, APE_PROGRESS_CALLBACK ProgressCallback, int * pKillFlag);
    DLLEXPORT int __stdcall ConvertFileW(const char * pInputFilename, const char * pOutputFilename, int nCompressionLevel, int * pPercentageDone, APE_PROGRESS_CALLBACK ProgressCallback, int * pKillFlag);
    DLLEXPORT int __stdcall VerifyFileW(const char * pInputFilename, int * pPercentageDone, APE_PROGRESS_CALLBACK ProgressCallback, int * pKillFlag, BOOL bQuickVerifyIfPossible = FALSE); 

    DLLEXPORT int __stdcall CompressFileW2(const char * pInputFilename, const char * pOutputFilename, int nCompressionLevel = COMPRESSION_LEVEL_NORMAL, IAPEProgressCallback * pProgressCallback = NULL);
    DLLEXPORT int __stdcall DecompressFileW2(const char * pInputFilename, const char * pOutputFilename, IAPEProgressCallback * pProgressCallback = NULL);
    ...
    DLLEXPORT int __stdcall VerifyFileW2(const char * pInputFilename, IAPEProgressCallback * pProgressCallback = NULL, BOOL bQuickVerifyIfPossible = FALSE); 
